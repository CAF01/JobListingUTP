namespace JobList.Framework.Validations.OfertasTrabajo
{
    ...
    public class InsertOfertaTrabajoExternaEgresadoValidation : AbstractValidator<InsertOfertaTrabajoExternaEgresadoRequest>
    {
        public InsertOfertaTrabajoExternaEgresadoValidation()
        {
            ...
            RuleFor(data => data.responsabilidades).NotNull().NotEmpty();
            ...
            RuleFor(data => data.detallesContacto.descripcionEmpresa).NotNull().WithMessage(ValidationResources.companyDescriptionRequired)
                ...
                .MinimumLength(ValidatorHelper.FIVETEEN).WithMessage(ValidationResources.companyDescriptionMinLength)
            ...
            RuleFor(data => data.detallesContacto.nombreResponsable).NotNull().WithMessage(ValidationResources.resTelephoneRequired)
                ...
                .MinimumLength(ValidatorHelper.FIVE).WithMessage(ValidationResources.resTelephoneMinLength)
                .MaximumLength(ValidatorHelper.EIGHTYFIVE).WithMessage(ValidationResources.resTelephoneMaxLength);
            ...
            RuleFor(data => data.detallesContacto.imgUrl)
                .MaximumLength(ValidatorHelper.ONEHUNDRED).WithMessage(ValidationResources.imgUrlMaxLength);
        }
    }
}
